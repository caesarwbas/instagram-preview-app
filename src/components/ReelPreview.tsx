...
const ReelPreview: React.FC<ReelPreviewProps> = ({
  ...
  return (
    <div className="reel-container">
      ...
      {/* Reel header label */}
      <div style={{ position: 'absolute', top: 44, left: 16, zIndex: 30, color: '#fff', fontWeight: 700, fontSize: 18, textShadow: '0 1px 3px rgba(0,0,0,0.5)' }}>
        Reels
      </div>
      <div style={{ position: 'absolute', top: 44, right: 16, zIndex: 30, color: '#fff' }}>
